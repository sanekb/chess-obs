...
- добавить новый **браузерный источник** в OBS с ссылкой на виджет
  (рекомендуемые размеры - 490x340)
- перед началом стрима установить "последнюю до-турнирную партию" по кнопке
  `Последняя`, включить `Авто`-загрузку всех новых партий
- _опционально во время стрима можно_:
...
- Админ-панелька работает в том числе с телефона
- Автообновление результатов партий происходит 1 раз в минуту в фоне (админку
  можно закрыть); выключается само через 2.5 часа после начала
...
- добавлен учёт **3100+** elo противников
